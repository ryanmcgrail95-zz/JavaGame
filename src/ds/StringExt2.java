...
public class StringExt2 {
	...
	public StringExt2() 				{set("");}
	public StringExt2(String str) 	{set(str);}
	public StringExt2(StringExt2 str) {set(str.get());}
	...
	public String munchTo(boolean munchAll, String substr) {
		...
		if(minInd == -1)
			...
			str = str.substring(minInd+substr.length());
			return outStr;
		}
	}
	...
	public String munchTo(boolean munchAll, String... substrs) {
		...
		if(minInd == -1)
			...
			String outStr = str.substring(0,minInd);
			str = str.substring(minInd+substrs[minPos].length());
			return outStr;
		}
	}
